...
window.addPlannedCampaign = addPlannedCampaign;
window.launchPlannedNow = launchPlannedNow;
window.deletePlannedCampaign = deletePlannedCampaign;
window.onPlanSectorChange = onPlanSectorChange;
window.initPlanificateur = initPlanificateur;
